...
def dashboard_routine():
    ...
    src = (ROOT / "docs/js/checklist.js").read_text()
...
def dashboard_schedule_push():
    """The body docs/js/device.js would POST to /schedule for that routine."""
...
def main():
    ...
    check("config.h fallback routine is drawable by docs/js/checklist.js",
    ...
    check("docs/js/checklist.js routine is a valid POST /schedule body",
